...
void AppWindow::updateBest(float best)
{
    sim_view_.setCenter(sf::Vector2f(best * SCALE, 300));
...
void AppWindow::updateInfo(std::string info)
{
    info_label_->SetText(info);
}

void AppWindow::updateList(int gen, float m)
{
